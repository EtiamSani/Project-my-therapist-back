...
class Patients extends CoreDatamapper {
    ...
    async getOnePatientWithAllAppointments(id){
        const preparedQuery ={
            ...
            t.lastname AS therapistName,a.beginninghour AS appointmentBegin, a.endtime AS appointmentEnd, a.videosession, a.audiosession, a.chatsession, a.sessionatoffice, t.profilpicture AS therapistProfilPicture
            FROM patients p
